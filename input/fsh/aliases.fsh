...
Alias: $NCIT = http://hl7.org/fhir/us/pq-cmc/CodeSystem/cmc-ncit-dummy //temp until server issue resolved
...
Alias: $EMAIDMP = http://hl7.org/fhir/us/pq-cmc/CodeSystem/cmc-ema-dummy //temp similar to NCIt 
Alias: $GENC = http://hl7.org/fhir/us/pq-cmc/CodeSystem/genc-country-codes-cs    //https://nsgreg.nga.mil
...
Alias: $TestCats = http://hl7.org/fhir/us/pq-cmc/CodeSystem/pqcmc-test-category-codes
