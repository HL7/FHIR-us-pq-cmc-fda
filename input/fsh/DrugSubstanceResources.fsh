...
Title: "Restest Date"		
Description: "The date after which samples of the drug substance should be examined to ensure compliance with the specification and thus suitable for use in the manufacture of a given drug product [Source: Adapted from Q1A(R2)]"			
* value[x] 1..1 MS		
* value[x] ^short = "Retest Date"	
...
* substance.strength.presentationRatio.numerator.code from  vsPqcmcUnitsofMeasureTerminology
...
* substance.strength.presentationRatio.denominator.code from  vsPqcmcUnitsofMeasureTerminology
...
* identifier.value ^short = "Batch or Lot Number (Bulk Batch ID)"
* instance = true		
* code MS		
