...
Example: 1000 kg
"""
* property[BatchSize].type = $BatchFormulaPropertyType#BatchSize "Batch Quantity"
...
* property[AddInfo].type = $BatchFormulaPropertyType#BatchAddInfo "Batch Formula Additional Information"
