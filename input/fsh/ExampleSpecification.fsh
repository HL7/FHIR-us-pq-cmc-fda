...
* action.code.coding[testCategory] = $NCIT#TC13 "Microbial Limits"
...
* action[0].code.coding[testCategory] = $NCIT#TC7 "Identification"
...
* action[1].code.coding[testCategory] = $NCIT#TC7 "Identification"
...
* action[2].code.coding[testCategory] = $NCIT#TC12 "Loss on Drying"
...
* action[3].code.coding[testCategory] = $NCIT#TC6 "Organoleptic"
* action[3].code.coding[testSubCat] = $NCIT#SBTC22 "Color of solution"
...
* action[=].code.coding[testCategory] = $NCIT#TC38 "Residue on Ignition"
* action[=].code.coding[methodOrigin] = $NCIT#C96102 "Compendial"
...
* action[=].code.coding[testCategory] = $NCIT#TC11 "Foreign and Particulate Matter"
* action[=].code.coding[methodOrigin] = $NCIT#C96103 "Proprietary"
...
* action[=].code.coding[testCategory] = $NCIT#TC53 "Impurity"
* action[=].code.coding[testSubCat] = $NCIT#SBTC92 "Specified identified impurity"
* action[=].code.coding[methodOrigin] = $NCIT#C96102 "Compendial"
...
* action[=].code.coding[testCategory] = $NCIT#TC53 "Impurity"
* action[=].code.coding[testSubCat] = $NCIT#SBTC98 "elemental impurity"
* action[=].code.coding[methodOrigin] = $NCIT#C96102 "Compendial"
...
* action[=].code.coding[testCategory] = $NCIT#TC53 "Impurity"
* action[=].code.coding[testSubCat] = $NCIT#SBTC100 "Impurities/Degradation Products/Related Substances"
* action[=].code.coding[methodOrigin] = $NCIT#C96103 "Proprietary"
...
* action[=].code.coding[testCategory] = $NCIT#TC53 "Impurity"
* action[=].code.coding[testSubCat] = $NCIT#SBTC101 "residual solvent"
* action[=].code.coding[methodOrigin] = $NCIT#C96102 "Compendial"
...
* action[=].prefix = "Single Stage"
* action[=].title = "Assay"
* action[=].code.coding[testCategory] = $NCIT#TC1 "Assay"
* action[=].code.coding[testSubCat] = $NCIT#SBTC2 "active ingredient"
* action[=].code.coding[methodOrigin] = $NCIT#C96103 "Proprietary"
...
* action[=].code.coding[testCategory] = $NCIT#TC9 "Dissolution"
* action[=].code.coding[methodOrigin] = $NCIT#C96103 "Proprietary"
...
* name[gsrs].name = "HUMAN SERUM ALBUMIN, RECOMBINANT RICE-DERIVED"  
...
* name[gsrs].name = "PROPYLENE GLYCOL MONOCAPRYLATE"
* name[gsrs].preferred = true
...
Instance: e187cf64-a2cf-4b51-acd0-07abe80481df
InstanceOf: EctdCompositionSP4151
Title: "eCTD Product Specification Composition SP4151"
Description: "Compositionion SP4151 implementing eCTD 3.2.P.5.1."
Usage: #example
...
* section[DrugProduct].title = "Product Specification - Buffered Asprin"
* section[DrugProduct].entry[0] = Reference(6EB934CF-94AA-4646-9346-93FC9A7A4558) 

Instance: 8eb07373-ad1e-4fc5-be47-3c7ce1225000
...
* identifier.value = "urn:uuid:8eb07373-ad1e-4fc5-be47-3c7ce1225000"
* timestamp = 2023-03-03T03:53:03.743Z
* meta.versionId = "0.1.15"
* entry[Composition].resource = e187cf64-a2cf-4b51-acd0-07abe80481df
* entry[Composition].fullUrl = "urn:uuid:e187cf64-a2cf-4b51-acd0-07abe80481df"
* entry[Composition].resource.meta.profile = "http://hl7.org/fhir/us/pq-cmc/StructureDefinition/ectd-composition-sp4151"
* entry[PlanDefinition].resource = 6EB934CF-94AA-4646-9346-93FC9A7A4558
* entry[PlanDefinition].fullUrl = "urn:uuid:6EB934CF-94AA-4646-9346-93FC9A7A4558"
* entry[PlanDefinition].resource.meta.profile = "http://hl7.org/fhir/us/pq-cmc/StructureDefinition/pqcmc-quality-specification"
* entry[MedicinalProductDefinition].resource = 8e854cea-f491-471f-b5dc-910f20135658
* entry[MedicinalProductDefinition].fullUrl = "urn:uuid:8e854cea-f491-471f-b5dc-910f20135658"
