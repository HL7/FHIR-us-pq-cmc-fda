...
* action[+]
  ...
  * code
    ...
    * text = "Visual"
  * reason[+].extension[categoryLevel].valuePositiveInt = 1
  * reason[=].coding = $TEMPH#C134255 "Loss on Drying"
  * documentation.type = #documentation
...
* action[+]
  ...
  * code
    ...
    * text = "Visual"
  * reason[+].extension[categoryLevel].valuePositiveInt = 1
  * reason[=].coding = $TEMPH#C193381 "Foreign and Particulate Matter"
  * documentation.type = #documentation
...
* action[+]
  ...
  * reason[+].extension[categoryLevel].valuePositiveInt = 2
  * reason[=].coding = $TEMPH#C205039 "Specified Identified Impurity"
  * documentation.type = #documentation
...
* action[+]
  ...
  * reason[=].coding = $TEMPH#C204971 "Impurity"
  * reason[+].extension[categoryLevel].valuePositiveInt = 2
  * reason[=].coding = $TEMPH#C134254 "Impurities/Degradation Products/Related Substances"
  * documentation.type = #documentation
...
* action[+]
  ...
  * code
    ...
    * text = "Visual"
  * reason[+].extension[categoryLevel].valuePositiveInt = 1
  * reason[=].coding = $TEMPH#C60819 "Assay"
  * reason[+].extension[categoryLevel].valuePositiveInt = 2
  * reason[=].coding = $TEMPH#C204845 "Active Ingredient Content"
  * documentation.type = #documentation
...
* action[+]
  ...
  * code
    ...
    * text = "Visual"
  * reason[+].extension[categoryLevel].valuePositiveInt = 1
  * reason[=].coding = $TEMPH#C134253 "Dissolution"
  * documentation.type = #documentation
