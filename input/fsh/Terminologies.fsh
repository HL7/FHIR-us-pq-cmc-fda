...
* $SectionTypes#ich_3.2.s "m3.2.s drug substance"
* $SectionTypes#ich_3.2.s.1 "m3.2.s.1 general information"
* $SectionTypes#ich_3.2.s.2 "m3.2.s.2 manufacture"
* $SectionTypes#ich_3.2.s.2.1 "m3.2.s.2.1 manufacturer(s)"
* $SectionTypes#ich_3.2.s.2.2 "m3.2.s.2.2 description of manufacturing process and process controls"
* $SectionTypes#ich_3.2.s.2.3 "m3.2.s.2.3 control of materials"
* $SectionTypes#ich_3.2.s.2.4 "m3.2.s.2.4 controls of critical steps and intermediates"
* $SectionTypes#ich_3.2.s.2.5 "m3.2.s.2.5 process validation and/or  evaluation"
* $SectionTypes#ich_3.2.s.2.6 "m3.2.s.2.6 manufacturing process development"
* $SectionTypes#ich_3.2.s.3 "m3.2.s.3 characterisation"
* $SectionTypes#ich_3.2.s.3.1 "m3.2.s.3.1 elucidation of structure and other characteristics"
* $SectionTypes#ich_3.2.s.3.2 "m3.2.s.3.2 impurities"
* $SectionTypes#ich_3.2.s.4 "m3.2.s.4 control of drug substance"
* $SectionTypes#ich_3.2.s.4.1 "m3.2.s.4.1 specification"
* $SectionTypes#ich_3.2.s.4.2 "m3.2.s.4.2 analytical procedures"
* $SectionTypes#ich_3.2.s.4.3 "m3.2.s.4.3 validation of analytical procedures"
* $SectionTypes#ich_3.2.s.4.4 "m3.2.s.4.4 batch analyses"
* $SectionTypes#ich_3.2.s.4.5 "m3.2.s.4.5 justification of specification"
* $SectionTypes#ich_3.2.s.5 "m3.2.s.5 reference standards or materials"
* $SectionTypes#ich_3.2.s.6 "m3.2.s.6 container closure system"
* $SectionTypes#ich_3.2.s.7 "m3.2.s.7 stability"
* $SectionTypes#ich_3.2.s.7.1 "m3.2.s.7.1 stability summary and conclusions"
* $SectionTypes#ich_3.2.s.7.2 "m3.2.s.7.2 post-approval stability protocol and stability commitment"
* $SectionTypes#ich_3.2.s.7.3 "m3.2.s.7.3 stability data"
* $SectionTypes#ich_3.2.p "m3.2.p drug product"
* $SectionTypes#ich_3.2.p.1 "m3.2.p.1 description and composition of the drug product"
* $SectionTypes#ich_3.2.p.2 "m3.2.p.2 pharmaceutical development"
* $SectionTypes#ich_3.2.p.2.1 "m3.2.p.2.1 components of the drug product"
* $SectionTypes#ich_3.2.p.2.2 "m3.2.p.2.2 drug product"
* $SectionTypes#ich_3.2.p.2.3 "m3.2.p.2.3 manufacturing process development"
* $SectionTypes#ich_3.2.p.2.4 "m3.2.p.2.4 container closure system"
* $SectionTypes#ich_3.2.p.2.5 "m3.2.p.2.5 microbiological attributes"
* $SectionTypes#ich_3.2.p.2.6 "m3.2.p.2.6 compatibility"
* $SectionTypes#ich_3.2.p.3 "m3.2.p.3 manufacture"
* $SectionTypes#ich_3.2.p.3.1 "m3.2.p.3.1 manufacturer(s)"
* $SectionTypes#ich_3.2.p.3.2 "m3.2.p.3.2 batch formula"
* $SectionTypes#ich_3.2.p.3.3 "m3.2.p.3.3 description of manufacturing process and process controls"
* $SectionTypes#ich_3.2.p.3.4 "m3.2.p.3.4 controls of critical steps and intermediates"
* $SectionTypes#ich_3.2.p.3.5 "m3.2.p.3.5 process validation and/or  evaluation"
* $SectionTypes#ich_3.2.p.4 "m3.2.p.4 control of excipients"
* $SectionTypes#ich_3.2.p.4.1 "m3.2.p.4.1 specifications"
* $SectionTypes#ich_3.2.p.4.2 "m3.2.p.4.2 analytical procedures"
* $SectionTypes#ich_3.2.p.4.3 "m3.2.p.4.3 validation of analytical procedures"
* $SectionTypes#ich_3.2.p.4.4 "m3.2.p.4.4 justification of specifications"
* $SectionTypes#ich_3.2.p.4.5 "m3.2.p.4.5 excipients of human or animal origin"
* $SectionTypes#ich_3.2.p.4.6 "m3.2.p.4.6 novel excipients"
* $SectionTypes#ich_3.2.p.5 "m3.2.p.5 control of drug product"
* $SectionTypes#ich_3.2.p.5.1 "m3.2.p.5.1 specification(s)"
* $SectionTypes#ich_3.2.p.5.2 "m3.2.p.5.2 analytical procedures"
* $SectionTypes#ich_3.2.p.5.3 "m3.2.p.5.3 validation of analytical procedures"
* $SectionTypes#ich_3.2.p.5.4 "m3.2.p.5.4 batch analyses"
* $SectionTypes#ich_3.2.p.5.5 "m3.2.p.5.5 characterisation of impurities"
* $SectionTypes#ich_3.2.p.5.6 "m3.2.p.5.6 justification of specifications"
* $SectionTypes#ich_3.2.p.6 "m3.2.p.6 reference standards or materials"
* $SectionTypes#ich_3.2.p.7 "m3.2.p.7 container closure system"
* $SectionTypes#ich_3.2.p.8 "m3.2.p.8 stability"
* $SectionTypes#ich_3.2.p.8.1 "m3.2.p.8.1 stability summary and conclusion"
* $SectionTypes#ich_3.2.p.8.2 "m3.2.p.8.2 post-approval stability protocol and stability commitment"
* $SectionTypes#ich_3.2.p.8.3 "m3.2.p.8.3 stability data"
* $SectionTypes#ich_3.2.a "m3.2.a appendices"
* $SectionTypes#ich_3.2.a.1 "m3.2.a.1 facilities and equipment"
* $SectionTypes#ich_3.2.a.2 "m3.2.a.2 adventitious agents safety evaluation"
* $SectionTypes#ich_3.2.a.3 "m3.2.a.3 excipients"
* $SectionTypes#ich_3.2.r "m3.2 r regional information"
* $SectionTypes#ich_3.3 "m3.3 literature references" 
