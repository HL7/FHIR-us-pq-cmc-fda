...
* The [resource definitions](definitions.xml.zip)  from this IG for use with the FHIR validator (see below)
* The full FHIR [R4B]({{site.data.fhir.path}}fhir-spec.zip) specifications
